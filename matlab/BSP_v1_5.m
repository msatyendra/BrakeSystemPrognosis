...
% v1.4 - Corrected the MLX90393 sensor parameter
% -------------------------------------------------
...
wear = ones(size(t)) * 100;  % Brake pad magnetic value stays almost constant
wear(end) = 99.9;  % Very tiny change to simulate microscopic wear
figure;
plot(t, wear, 'm');
